...
public:
    ...
    explicit UserService(
        ...
        std::shared_ptr<dao::UserDAO> user_dao,
    ...
    // Create
    CreateUserResult
    create_user(const std::string &first_name, const std::string &last_name,
                const std::string &email, const std::string &role_name = "USER",
    ...
    bool add_role_to_user(const std::string &email,
                          ...
                          const std::shared_ptr<const models::User> &actor = nullptr);
    bool
    remove_role_from_user(const std::string &email, const models::UserRole role,
                          const std::shared_ptr<const models::User> &actor = nullptr);
