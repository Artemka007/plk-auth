...
6. Я администратор, я хочу получать логги своих действий.
7. Я администратор, я хочу импортировать/экспортировать БД.

Пользователь
1. Я пользователь, я хочу войти в систему.
2. Я пользователь, я хочу сменить пароль.
3. Я пользователь, я хочу получать уведомления о действиях администратора.
